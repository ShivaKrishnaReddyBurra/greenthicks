...
const createProduct = [
  ...
  body('category').isIn(['leafy', 'fruit', 'root', 'herbs', 'milk', 'pulses', 'grains', 'spices', 'nuts', 'oils', 'snacks', 'beverages']),
...
const updateProduct = [
  ...
  body('originalPrice').optional().isFloat({ min: 0 }),
  body('category').optional().isIn(['leafy', 'fruit', 'root', 'herbs' , 'milk', 'pulses', 'grains', 'spices', 'nuts', 'oils', 'snacks', 'beverages']),
