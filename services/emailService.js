...
const sendOTP = async (email, otp) => {
  const mailOptions = {
    ...
    html: `
      ...
      <img src="https://github.com/ShivaKrishnaReddyBurra/greenthicks-frontend/blob/main/src/public/favicon.ico" alt="Logo" style="display: block; margin: 0 auto; width: 100px; height: auto;">
